...
6. **MODE PLANIFICACIÓ PER CANVIS ESTRUCTURALS O E CONTINGUTS IMPORTANTS:** Si els canvis impliquen modificar moltes estructures, elements o parts del document, hauras d'activar el mode planificació, planificar els teus moviments i canvis en funció del que t'hagi demanat i de tot el que estigui implicat en aquest, i demanar la meva autoritzacio un cop em presentis aquest pla.
...
4. **COMPILACIÓ:** abans de donar per finalitzat una tasca del document, compilaras el codi en un PDF, i si mostra errors greus de compilacio t'asseguraras d'talar dependencies o buscar per internet la solució a aquests, PREVAL mantenir les estructures, fonts i elements per sobre d'ELIMINAR-LOS, és a dir: no intentis arreglar els errors eliminant elements, paquets o estructures, busca la manera de preservar-los.
