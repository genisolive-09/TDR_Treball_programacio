...
\input{sections/01_resum-abstract.tex}
\input{sections/02_introduccio.tex}
\input{sections/03_objectius-hipotesi.tex}
\input{sections/04_marc-teoric.tex}
\input{sections/05_metodologia.tex}
\input{sections/06_conclusions.tex}
\input{sections/07_bibliografia.tex}
\input{sections/08_annexos.tex}
